...
public class EditorAspectDescriptorImpl implements EditorAspectDescriptor {
  ...
  private static String[] stringSwitchCases_xbvbvu_a0a0b = new String[]{"Shapes.structure.Canvas", "Shapes.structure.Circle", "Shapes.structure.ColorReference", "Shapes.structure.Square"};
  private static String[] stringSwitchCases_xbvbvu_a0a0c = new String[]{"Shapes.structure.Shape"};
}
